...
void CreateIndexResponse::setByJson(const Json::Value &response) {
    ...
    this->shards_acknowledged_ =
      response.get("shards_acknowledged", false).asBool();
...
CreateIndexResponsePtr IndicesClient::create(
  const string &indexName, const CreateIndexParam &param
) const {
    unique_ptr<promise<CreateIndexResponsePtr>>
         pro(new promise<CreateIndexResponsePtr>);
    auto f = pro->get_future();
    this->create(
      indexName,
      [&pro](CreateIndexResponsePtr &response) {
          try {
...
GetIndexResponsePtr IndicesClient::get(const string &indexName) const {
    unique_ptr<promise<GetIndexResponsePtr>>
         pro(new promise<GetIndexResponsePtr>);
    auto f = pro->get_future();
    this->get(
      indexName,
      [&pro](GetIndexResponsePtr &response) {
          try {
              pro->set_value(response);
          } catch (...) {
              pro->set_exception(current_exception());
...
PutMappingResponsePtr IndicesClient::putMapping(
  const string &indexName, const PutMappingParam &param
) const {
    unique_ptr<promise<PutMappingResponsePtr>>
         pro(new promise<PutMappingResponsePtr>);
    auto f = pro->get_future();
    this->putMapping(
      indexName,
      [&pro](PutMappingResponsePtr &response) {
          try {
              pro->set_value(response);
          } catch (...) {
              pro->set_exception(current_exception());
...
DeleteIndexResponsePtr IndicesClient::deleteIndex(const string &indexName
) const {
    unique_ptr<promise<DeleteIndexResponsePtr>>
         pro(new promise<DeleteIndexResponsePtr>);
    auto f = pro->get_future();
    this->deleteIndex(
      indexName,
      [&pro](DeleteIndexResponsePtr &response) {
          try {
              pro->set_value(response);
          } catch (...) {
              pro->set_exception(current_exception());
